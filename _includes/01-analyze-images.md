...
1. Observe the output, which should include a suggested caption for the **street.jpg** image, which looks like this:
    ...
    ![A picture of a busy street.](https://raw.githubusercontent.com/MicrosoftLearning/mslearn-ai-vision/refs/heads/main/Instructions/media/street.jpg)
...
1. Run the program again, this time with the argument **images/building.jpg** to see the caption that gets generated for the **building.jpg** image, which looks like this:
    ...
    ![A picture of a building.](https://raw.githubusercontent.com/MicrosoftLearning/mslearn-ai-vision/refs/heads/main/Instructions/media/building.jpg)

1. Repeat the previous step to generate a caption for the **images/person.jpg** file, which looks like this:

    ![A picture of a person.](https://raw.githubusercontent.com/MicrosoftLearning/mslearn-ai-vision/refs/heads/main/Instructions/media/person.jpg)
...
1. Use the (Azure cloud shell-specific) **download** command to download the **objects.jpg** file:
   ...
   download objects.jpg
    ...
    ![An image with object boundary boxes.](https://raw.githubusercontent.com/MicrosoftLearning/mslearn-ai-vision/refs/heads/main/Instructions/media/objects.jpg)
